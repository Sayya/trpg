...
class Test:
    def __init__(self):
        ...
        Event('R1', 'Battle_COM', (0, 0, 1), ('鬼A',''), text='鬼Aの攻撃\n誰が攻撃を受けますか？')
        Event('R1n', 'Battle_Dec', (0, 0, 0), ('',''))
        Event('R2', 'Battle_COM', (0, 1, 0), ('','鬼A'), text='桃太郎陣営の攻撃')
        Event('R2n', 'Battle_Dec', (0, 0, 0), ('',''))
        Event('R3', text='さらに鬼が襲いかかってきた')
        Event('R4', 'Battle_COM', (0, 0, 1), ('鬼B',''), text='鬼Bの攻撃\n誰が攻撃を受けますか？')
        Event('R4n', 'Battle_Dec', (0, 0, 0), ('',''))
        Event('R5', 'Battle_COM', (0, 1, 0), ('','鬼B'), text='桃太郎陣営の攻撃')
        Event('R5n', 'Battle_Dec', (0, 0, 0), ('',''))
        Event('R6', 'OneOfTwo', text='何かが近づいてくる！？')
        Event('R7', text='大鬼が現れた')
        Event('R8', 'Battle_COM', (0, 0, 1), ('大鬼',''), text='大鬼の攻撃\n誰が攻撃を受けますか？')
        Event('R8n', 'Battle_Dec', (0, 0, 0), ('',''))
        Event('R9', 'Battle_COM', (0, 1, 0), ('','大鬼'), text='桃太郎陣営の攻撃')
        Event('R9n', 'Battle_Dec', (0, 0, 0), ('',''))
        Event('R10', text='大鬼は滅ぼされた\n故郷に平和が戻った')
        Event('gameover', text='ゲームオーバー')

        Event('RK0', 'Battle_Bar', (0, 0, 0), ('','きびだんご'))
        Event('RK1', 'Battle_Inc', (0, 0, 1), ('きびだんご',''))
        Event('RK2', 'Battle_Bar', (0, 0, 0), ('きび単位','きびだんご'))
