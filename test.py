...
class Test:
    def __init__(self):
        ...
        Thing('鬼A', {'力': 6, '感': 5, '知': '2d6+5', '戦': '2d3+8', })
        Thing('鬼B', {'力': 8, '感': 3, '知': '2d6+5', '戦': '2d3+10', })
        Thing('大鬼', {'力': 10, '感': 8, '知': '2d6+5', '戦': '2d3+15', })
        ...
        Event('R1', 'Battle_COM', (0, 0, 1, 0), ('鬼島','太郎'), ('鬼A',''), text='鬼Aの攻撃\n誰が攻撃を受けますか？')
        ...
        Event('R4', 'Battle_COM', (0, 0, 1, 0), ('鬼島','太郎'), ('鬼B',''), text='鬼Bの攻撃\n誰が攻撃を受けますか？')
        ...
        Event('R8', 'Battle_COM', (0, 0, 1, 0), ('鬼島','太郎'), ('大鬼',''), text='大鬼の攻撃\n誰が攻撃を受けますか？')
